...
public class FoodProductTypeRepositoryTest {
	...
	private static final String TEST_TYPE1 = "TEST_TYPE1";
	...
	@Before
	public void setup() {
		deleteItem(TEST_TYPE1);
		FoodProductType fpt1 = repo.save(new FoodProductType(TEST_TYPE1));
	}
	...
	public void testGetById() {
		FoodProductType fpt1 = repo.findByName(TEST_TYPE1);
	...
	public void testGetByName() {
		FoodProductType fpt = repo.findByName(TEST_TYPE1);
		assertEquals(TEST_TYPE1, fpt.getName());
	}

	@Test
	@DirtiesContext
	public void testAddProductType() {
		FoodProductType fpt1 = repo.save(new FoodProductType(TEST_TYPE2));
		FoodProductType fpt2 = repo.findById(fpt1.getId());
		assertEquals(fpt1.getId(), fpt2.getId());
	...
	public void testAddDuplicateProductType() {
		FoodProductType fpt = new FoodProductType(TEST_TYPE1);
		try {
			repo.save(fpt);
